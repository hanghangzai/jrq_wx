<template>
<x-input :placeholder="placeholder" :title='title' :required="required" ref="numeric" type="tel" v-model="amount" :readOnly="readOnly" :disabled="disabled"  @on-blur="onBlurHandler"  @on-change="onInputHandler"
  @on-focus="onFocusHandler"></x-input>
</template>
